...
class DoctorsCat extends StatefulWidget {
  final PageNav pageNav;
  const DoctorsCat({Key key, this.pageNav}):super(key:key);
  @override
  _DoctorsCatState createState() => _DoctorsCatState();
}

class _DoctorsCatState extends State<DoctorsCat> {
