...
class LabPresciption extends StatefulWidget{

  _LabPrescriptionState createState()=> _LabPrescriptionState();

}

class _LabPrescriptionState extends State<LabPresciption>{
  ...
  Widget build(BuildContext context) {
   ...
   Future<List<Doctor>> _fetchPrescriptions() async {
    ...
    final http.Response response = await http
      ...
      '${webhook}tasks.task.list?filter[UfAuto831530867848]=$id&filter[TITLE]="Lab  Prescription',
    )
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                IconButton(
                  onPressed: (){
                   confirmDialog( context, "Tests requested by ${data.elementAt(index)['RESPONSIBLE_ID']} ");
                  },
