...
class _AcountWidgetState extends State<AcountWidget> {
  String fullname,
      photoUrl =
          'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRQHLSQ97LiPFjzprrPgpFC83oCiRXC0LKoGQ&usqp=CAU';
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                snapshot.data['PHONE'][0]['VALUE'] == "0404"&&
                                    snapshot.data['UF_CRM_1597424448103'] ==
                                            null
                            ...
                            child: FlatButton(
                              ...
                              onPressed: () async {
                                ...
                                preferences.setString(
                                    'city', snapshot.data['ADDRESS_CITY']);

                                Profile profile = Profile(
                                    int.parse(snapshot.data['ID']),
                                    snapshot.data['NAME'],
                                    snapshot.data['SECOND_NAME'],
                                    snapshot.data['LAST_NAME'],
                                    snapshot.data['PHONE'][0]['VALUE'],
                                    snapshot.data['ADDRESS_CITY'],
                                    snapshot.data['EMAIL'][0]['VALUE'],
  ...
  Widget _dropDownListe(Icon icon, String title, double borderWidth,
