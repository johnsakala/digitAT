...
class BookDignosticsOnline extends StatefulWidget {
  final PageNav pageNav;
  const BookDignosticsOnline({Key key, this.pageNav}) : super(key: key);
  @override
  _BookDignosticsOnlineState createState() => _BookDignosticsOnlineState();
}
...
class _BookDignosticsOnlineState extends State<BookDignosticsOnline> {
  ...
  Future<List<dynamic>> _suggestTests(String pattern) async {
    List<dynamic> result = [];

    for (int i = 0; i < alltests.length; i++) {
      print(pattern);
      print(alltests[i]['NAME']);
      print(alltests[i]['NAME'].contains(pattern, 1));
...
//  showAlertDialog(context);
    final http.Response response = await http
        .get(
          '${webhook}crm.product.list?filter[SECTION_ID]=$laId',
        )
                ...
                children: <Widget>[
                  ...
                  Padding(
                          ...
                          suggestionsCallback: (pattern) async {
                            return await _suggestTests(pattern);
                          },
                          transitionBuilder:
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context)
                        .pushNamed("/secondlabsbooking", arguments: list);
                  },
