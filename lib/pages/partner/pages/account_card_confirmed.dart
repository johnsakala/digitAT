...
class AccountConfirmedCard extends StatefulWidget {
  const AccountConfirmedCard({Key key,this.patient}) : super(key:key);

  final PatientCard patient;

  @override
  _AccountConfirmedCardState createState()=> _AccountConfirmedCardState();
}
 class _AccountConfirmedCardState extends State<AccountConfirmedCard>{
    bool attended;
   String name;
   String date;
  String hour;
