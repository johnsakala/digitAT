...
class PharmaHubPrescription extends StatefulWidget{

  @override
  PharmaHubPrescriptionState createState()=> PharmaHubPrescriptionState();
}

class PharmaHubPrescriptionState extends State<PharmaHubPrescription>{
  ...
  Widget build(BuildContext context) {
   ...
   Future<List<Doctor>> _fetchPrescriptions() async {
    ...
    final http.Response response = await http
      ...
      '${webhook}tasks.task.list?filter[UfAuto831530867848]=$id&filter[TITLE]=Medicines Prescription',
    )
