import 'dart:async';
import 'dart:io';
import 'package:digitAT/comm/fullScreenImageViewer/FullScreenImageViewer.dart';
import 'package:digitAT/comm/fullScreenVideoViewer/FullScreenVideoViewer.dart';
import 'package:digitAT/config/constants.dart';
import 'package:digitAT/main.dart';
import 'package:audio_recorder/audio_recorder.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:digitAT/comm/chat/PlayerWidget.dart';
import 'package:digitAT/comm/videoCall/VideoCallScreen.dart';
import 'package:digitAT/comm/videoCallsGroupChat/VideoCallsGroupScreen.dart';
import 'package:digitAT/comm/voiceCall/VoiceCallScreen.dart';
import 'package:digitAT/comm/voiceCallsGroupChat/VoiceCallsGroupScreen.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String audioMessageTime = 'startRecording';
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          if (snapshot.hasData &&
                            ...
                            return Center(child: Text('noMessagesYet'));
                          } else {
    ...
    final action = CupertinoActionSheet(
      ...
      actions: <Widget>[
        CupertinoActionSheetAction(
          ...
          child: Text("leaveGroup"),
          isDefaultAction: false,
          onPressed: () async {
            Navigator.pop(context);
            showProgress(context, 'leavingGroupChat', false);
  ...
  _sendMessage(String content, Url url, String videoThumbnail) async {
    ...
    if (await _checkChannelNullability(
      ...
      showAlertDialog(context, 'anErrorOccurred',
          'failedToSendMessage');
    }
  }
  ...
  _onSendRecord() async {
    ...
    setState(() {
      audioMessageTime = 'startRecording';
      currentRecordingState = RecordingState.HIDDEN;
    });
    Url url =
